            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              FittedBox(
                child: Column(
                  ...
                  children: [
                    // Show discount only if it's more than 0
                    if (couponController.couponList![index].discount != 0.0)
                      Text(
                    ...
                    // Always show cashback if available
                    if (couponController.couponList![index].amountDiscount != null && couponController.couponList![index].amountDiscount! > 0)
                      Text(
                        '${PriceConverter.convertPrice(couponController.couponList![index].amountDiscount)} ${'cashback'.tr}',
                        style: robotoBold.copyWith(fontSize: Dimensions.fontSizeDefault),
                      ).paddingOnly(left: 5),
                  ],
                ),
              ...
              couponController.couponList![index].restaurant == null ?  Flexible(child: Text(
                ['store_wise', 'restaurant_wise'].contains(couponController.couponList![index].couponType) ?
