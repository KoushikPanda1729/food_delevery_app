...
class PalateServiceBottomSheet extends StatelessWidget {
  final PalateServiceController controller;

  const PalateServiceBottomSheet({super.key, required this.controller});
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Column(
          ...
          children: [
            Text('Select Service', style: robotoMedium),
