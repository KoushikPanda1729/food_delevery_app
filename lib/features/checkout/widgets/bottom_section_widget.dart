...
class BottomSectionWidget extends StatelessWidget {
  ...
  const BottomSectionWidget({
    ...
    required this.guestEmailNode, required this.isBogo,
  });
  ...
  Widget pricingView(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if(couponController.discountAmount != null && couponController.discountAmount! > 0) Container(
          ...
          child: Row(children: [
            Image.asset(Images.moneyBag, height: 25, width: 25, fit: BoxFit.cover, ),
            const SizedBox(width: Dimensions.paddingSizeSmall),
            Expanded(child: Text('${'you_will_get'.tr} ${PriceConverter.convertPrice(couponController.discountAmount)} ${'cashback'.tr}', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault),)),
          ]),
        ).paddingOnly(top: Dimensions.paddingSizeSmall),
