...
class CouponSection extends StatelessWidget {
  ...
  final double total;
  final bool isBogo;
  const CouponSection({super.key, required this.checkoutController, required this.price, required this.discount, required this.addOns, required this.deliveryCharge, required this.total, required this.charge, required this.isBogo});

  @override
  Widget build(BuildContext context) {
    bool isDesktop = ResponsiveHelper.isDesktop(context);
    return isBogo ? const SizedBox() : GetBuilder<CouponController>(
