        ...
        return GetBuilder<CheckoutController>(
          builder: (checkoutController) {
            ...
            return GetBuilder<CouponController>(builder: (couponController) {
              ...
              double cashBackAmount = couponController.discountAmount ?? 0;
              double totalSaved = discount + couponDiscount + cashBackAmount;
              bool isBogo = false;
              ...
              if(_cartList != null) {
                for(CartModel cartModel in _cartList!) {
                  if(cartModel.product!.isBogo != null && cartModel.product!.isBogo!) {
                    isBogo = true;
                    break;
                  }
                }
                ...
                children: [
                  ...
                  if(totalSaved > 0) Container(
                    ...
                    child: Row(
                      ...
                      children: [Image.asset(Images.moneyBagGif, height: 35, color: Theme.of(context).cardColor, width: 40, fit: BoxFit.cover,),
                        const SizedBox(width: Dimensions.paddingSizeSmall),
                        Text(
                          '${'total_saved'.tr}: ${PriceConverter.convertPrice(totalSaved)}',
