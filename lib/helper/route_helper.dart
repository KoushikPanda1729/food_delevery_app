...
import 'package:stackfood_multivendor/features/bogo/screens/bogo_screen.dart';
...
class RouteHelper {
  ...
  static String getBogoRoute({String? restaurantId}) {
    return restaurantId != null ? '$bogo?restaurant_id=$restaurantId' : bogo;
  }
