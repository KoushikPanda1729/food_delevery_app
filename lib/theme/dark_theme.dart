...
ThemeData dark = ThemeData(
  ...
  colorScheme: const ColorScheme.dark(primary: Color(0xFFE34234),
      tertiary: Color(0xff6165D7),
      tertiaryContainer: Color(0xff171DB6),
      secondary: Color(0xFFFFCA12)).copyWith(background: const Color(0xFF191A26)).copyWith(error: const Color(0xFFdd3135)),
